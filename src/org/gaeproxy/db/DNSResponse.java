...
public class DNSResponse implements Comparable<DNSResponse> {
  ...
  @Override
  public int compareTo(DNSResponse dnsResponse) {
    return (int) (reqTimestamp - dnsResponse.getReqTimestamp());
  }
}
